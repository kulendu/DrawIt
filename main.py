...
while True: 
    ...
    # for colour access 
    frame = cv2.rectangle(frame, (40, 1), (135, 45),  (122, 122, 122), -1) 
    frame = cv2.rectangle(frame, (160, 1), (255, 45), colors[0], -1) 
    frame = cv2.rectangle(frame, (275, 1), (370, 45), colors[1], -1) 
    frame = cv2.rectangle(frame, (390, 1), (485, 45), colors[2], -1) 
    frame = cv2.rectangle(frame, (505, 1), (600, 45), colors[3], -1) 
